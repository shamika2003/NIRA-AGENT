...
/// present in the trusted SegaCapabilityApprovalBroker.
/// </summary>
public partial class PermissionToastWindow : Window
{
    private readonly SegaScopedCapabilityAuthorizer
        _authorizer;

    private readonly SegaCapabilityApprovalBroker
        _broker;
    ...
    public PermissionToastWindow(
        SegaScopedCapabilityAuthorizer authorizer,
    ...
    public void ShowPending()
    {
        ...
        IReadOnlyList<SegaApprovalRequest> pending =
    ...
    private void RefreshRequest(
        IReadOnlyList<SegaApprovalRequest> pending)
    {
        SegaApprovalRequest request =
            pending[0];

        SegaAuthorityOperation operation =
            request.Operation;
        ...
        PendingCountText.Text =
            pending.Count == 1
                ? "1 action is waiting"
                : $"{pending.Count} actions are waiting · showing the oldest";
        ...
        ReasonText.Text =
            string.IsNullOrWhiteSpace(
                ...
                ? "Sega needs this action to continue the current work."
                : operation.Request.Reason;
        ...
        StatusText.Text =
            "Waiting for your decision · this alert never steals keyboard focus";
