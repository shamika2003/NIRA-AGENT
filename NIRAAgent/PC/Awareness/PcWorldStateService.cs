    ...
    : BackgroundService
{
    ...
    // NIRAPresenceService owns raw physical body facts.
    ...
    private PcNIRAPresenceState BuildNIRAState(
        PcWorldState world,
        NIRAPresenceSnapshot presence)
    {
        if (
            ...
            presence.WindowHandle ==
                IntPtr.Zero)
        {
            return new PcNIRAPresenceState();
        }


        PcDisplayState NIRADisplay =
            _awareness
