...
public sealed class NIRATemporalCommitmentReconciliationService
    : BackgroundService
{
    ...
    private readonly NIRASelfModelStore _store;
    private readonly NIRATemporalCommitmentReasoner _reasoner;

    public NIRATemporalCommitmentReconciliationService(
        NIRASelfModelService selfModel,
        NIRASelfModelStore store,
        NIRATemporalCommitmentReasoner reasoner)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            // Reconciliation is repair work, never a reason to kill NIRA's
    ...
    private async Task ReviewCandidatesAsync(
        CancellationToken cancellationToken)
    {
        NIRACommitmentState[] candidates =
        ...
        foreach (NIRACommitmentState commitment in candidates)
        {
            ...
            NIRATemporalInterpretationResult result;
